...
var dataEasy = [
    {
        ...
        story:
            'Amazon was founded in Bellevue, Washington, on July 5, 1994. The company started as an online marketplace for books but expanded to sell just about everything',
        level: 'easy',
    },
...
var dataMedium = [
...

    {
        ...
        answer: ['virginia'],
        story:
            'Amazon plans to have 25,000 employees at HQ2 by 2030 and is partnering with Virginia Tech to support the development of high-tech talent',
        level: 'medium',
    },
...

    {
        ...
        answer: ['amazon go'],
        story:
            "Amazon Go stores are equipped with hundreds of sensors, keeping a virtual shopping cart so customers can just walk out when they're done shopping",
        level: 'medium',
    },

    {
        ...
        answer: ['door', 'a door'],
        story:
            'Cheap doors and sawed off two by fours were used as desks to save money in the early days of Amazon. This mindset of frugality continues to this day',
        level: 'medium',
    },
...
var dataHard = [
...

    {
        ...
        story:
            'Authored by Douglas Hofstadter, this book tackles the subject of artificial intelligence and machine learning',
        level: 'hard',
    },
...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        ...
        askTeamsBool = false;
        return handlerInput.responseBuilder.speak(speechText).reprompt(helpMessage).getResponse();
    },
};
...
const QuizHandler = {
    canHandle(handlerInput) {
        ...
        return (
            request.type === 'IntentRequest' && //askTeamsBool &&
...
const LeaderboardHandler = {
    ...
    async handle(handlerInput) {
        ...
        const postData = async (leaderName, userid) => {
        ...
        const getAverage = (recordCount, totalScore, userid, place, leaderName) => {
            return new Promise((resolve, reject) => {
                base('Leaderboard')
                    .select({
        ...
        const success = await postData(leaderName, userid);
...
const ErrorHandler = {
    ...
    handle(handlerInput, error) {
        ...
        return handlerInput.responseBuilder.speak(errorMessage).reprompt(errorMessage).getResponse();
    },
};
...
function getFinalScore(attributes) {
    ...
    if (attributes.numPlayers == 1) {
        response =
            ...
            highScore +
            ` points. Great job! Come back soon for more trivia! What is your name?`;
    } else {
        response =
            `The results are in. ` +
            winners +
            ` won with ` +
            highScore +
            ` points. Great job everyone! Come back soon for more trivia! What is your name?`;
    }
