...
const base = new Airtable({apiKey: 'YOURKEYHERE'}).base('appPCPv2GlOfZ6wLe');
...
const QuizHandler = {
    ...
    return response.speak(speakOutput)
                    .withStandardCard(`Quiz Time!`, speakOutput, pictureUrl)
  ...
  const QuizAnswerHandler = {
    ...
    handle(handlerInput) {
      ...
      if (attributes.counter < (numRounds * attributes.numPlayers)) {
        ...
        return response.speak(speakOutput)
        .reprompt(speakOutput)
        .withStandardCard(`Quiz Time`, question, pictureUrl)
        .getResponse();
      }
      else {
        ...
        return response.speak(speakOutput)
        .withStandardCard(`The results are in!`, getFinalScore(attributes), pictureUrl)
  ...
  const LeaderboardHandler = {
    ...
    async handle(handlerInput) {
        ...
        return handlerInput.responseBuilder.speak(speechText).withStandardCard(`You're on the leaderboard!`, speechText, pictureUrl).getResponse();
    },
};
